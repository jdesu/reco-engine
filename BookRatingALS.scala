...
object BookRatingALS {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val fileName = "datasets/sample1.csv"
    ...
    val custFile = "mappings/book_ratings/customerToId"
    val asinFile = "mappings/book_ratings/asinToId"
